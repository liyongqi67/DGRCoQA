...
# ##############################yongqi
        question_history_graph=entry['question_history_graph']

        graph_feature_dict={
        'node_set_list':question_history_graph[0],
        'edge_set_list':question_history_graph[1],
        'node_is_historyanswer':question_history_graph[2],
        'node_label':question_history_graph[3]
        }

# ##############################yongqi
        return return_feature_dict,graph_feature_dict
