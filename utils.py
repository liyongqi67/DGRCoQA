...
def write_final_predictions(args, all_predictions, final_prediction_file, 
...
###############################yongqi    #发现原作者的bug
        ...
        if use_retriever_prob:
            total_scores = total_scores+retriever_scores
###############################yongqi      
...
def get_retrieval_metrics(evaluator, all_predictions, eval_retriever_probs=False):
    ...
    # print('rerank_mrr_list',rerank_mrr_list)
    rerank_recall_list = [v['recall_5'] for v in rerank_metrics.values()]
    # print('rerank_recall_list',rerank_recall_list)    
    ...
    if eval_retriever_probs:
        ...
        # print('retriever_run', retriever_run)
        # print('retriever_mrr_list', retriever_mrr_list)
        # print('retriever_recall_list', retriever_recall_list)
